<template>
  <div class="footer">
    ...
    <div class="copyright">
      ...
      <span><img style="height:15px" :src="require('../assets/images/guo.png')" /><a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31010602005194" style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img src="" style="float:left;"/><p style="float:left;height:20px;line-height:25px;margin: 0px 0px 0px 5px; color:#939393;">沪公网安备 31010602005194号</p></a></span>
    </div>
  </div>
</template>
