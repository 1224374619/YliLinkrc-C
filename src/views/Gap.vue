<template>
  <div class="gap">
    <div class="gap-left">
      ...
      <span>你还没有在线简历信息呦</span>
      <span style="margin:10px 0 0 0">编辑在线简历，可以大大提升投递成功率</span>
      <el-button style="width:212px;height:43px" @click="next" type="primary">立即创建简历</el-button>
