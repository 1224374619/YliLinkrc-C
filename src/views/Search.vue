<template>
  <div class="home">
    <nav>
      <img
        src="https://sxsimg.xiaoyuanzhao.com/static/new_main/img/logo.png?v=ca7e7ee7a9339caf25d8e12d055eb1e8"
      />
      <div class="menu">
        <div class="btn-set">
          <button>登陆</button>
      ...
      <div class="left">
                ...
                <el-collapse>
                  <el-collapse-item>
                    ...
                    <el-checkbox-group v-model="filters.district" size="mini">
                      <el-checkbox-button
                        v-for="district in citiesMapper[filters.city]"
                        :label="district"
                        :key="district"
                      >{{district}}</el-checkbox-button>
                    </el-checkbox-group>
                  </el-collapse-item>
                </el-collapse>
              </el-form-item>
        ...
        <div class="search-result">
          <div class="occupation-card">
            <div class="container">
              <div class="desc">
                <h3 @click="redirectToDetailPage(1)">
                  Web 前端架构师 [上海-徐汇区]
                  <span>10:30 发布</span>
                </h3>
                <div class="meta">
