    ...
    <div class="home">
      ...
      <div class="button">
        <el-button
          plain
          @click="more"
          style="width:178px;height:43px;font-size:18px;background:#02B9B8;color:#ffffff;border-color:#02B9B8;letter-spacing:6px;text-align:center;padding-left:6px;margin:60px 0 100px 0"
        >查看更多</el-button>
      </div>
    </div>
  </div>
